...
export default function StakePage() {
  ...
  useEffect(() => {
    const initializeContracts = async () => {
      if (!connectedAccount || !signer || !deploymentInfo) return;
      
      try {
        // Initialize contracts from deployment info
        const nusdContractAddress = deploymentInfo.nusd;
        const sNusdContractAddress = deploymentInfo.sNUSD;
        const stakingContractAddress = deploymentInfo.stakingContract;
        
        console.log("Using contract addresses:", {
          nusd: nusdContractAddress,
          sNusd: sNusdContractAddress,
    ...
    initializeContracts();
  }, [connectedAccount, signer, deploymentInfo, getContract]);
  ...
  const handleUnstake = async () => {
    ...
    try {
      ...
      // Now unstake sNUSD
      const unstakeTx = await stakingContract.initiateUnstake(amount);
