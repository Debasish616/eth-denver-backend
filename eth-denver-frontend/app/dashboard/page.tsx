      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold">AI Arbitrage Command Center</h1>
              <p className="text-muted-foreground">Monitor and control your AI trading operations</p>
            </div>
            
            <div className="mt-4 md:mt-0 flex items-center space-x-2">
              <div className={`px-3 py-1 rounded-full flex items-center ${isTrading ? 'bg-green-500/20 text-green-400 animate-pulse' : 'bg-muted text-muted-foreground'}`}>
                <Zap className={`h-4 w-4 mr-1 ${isTrading ? 'text-green-400' : 'text-muted-foreground'}`} />
                <span className="text-sm font-medium">{isTrading ? 'AI Active' : 'AI Paused'}</span>
              </div>
              <Switch 
                id="trading-mode" 
                checked={isTrading}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <Card className="glassmorphism overflow-hidden">
              ...
              <CardContent>
                <div className="flex items-center">
                  <DollarSign className="h-5 w-5 text-green-400 mr-2" />
                  <span className="text-2xl font-bold">${todayProfit.toLocaleString()}</span>
                </div>
                <div className="flex items-center mt-2 text-sm text-green-400">
                  <ArrowUpRight className="h-4 w-4 mr-1" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <Card className="glassmorphism overflow-hidden">
              ...
              <CardContent>
                <div className="flex items-center">
                  <RefreshCw className="h-5 w-5 text-purple-400 mr-2" />
                  <span className="text-2xl font-bold">${inArbitrage.toLocaleString()}</span>
                </div>
                <div className="flex items-center mt-2 text-sm text-muted-foreground">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <Tabs defaultValue="profit" className="mb-8" value={activeChartTab} onValueChange={setActiveChartTab}>
                  ...
                  <Card className="glassmorphism">
                    <CardHeader>
                      <div className="flex justify-between items-center">
                        ...
                        <Tabs defaultValue="daily" value={activeChartPeriod} onValueChange={setActiveChartPeriod} className="w-auto">
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-border/40">
                          ...
                          <th className="text-right py-3 px-4 text-muted-foreground font-medium">Execution</th>
              ...
              <Card className="glassmorphism">
                <CardHeader>
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant="outline" className={`${isTrading ? 'bg-green-500/20 text-green-400' : 'bg-muted text-muted-foreground'}`}>
              ...
              <Card className="glassmorphism mb-8">
                ...
                <CardContent>
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <Label htmlFor="max-capital">Max Capital Per Trade</Label>
                        <span className="text-sm text-muted-foreground">{maxCapital}%</span>
                      </div>
                      <Slider 
                        id="max-capital"
                        min={5} 
